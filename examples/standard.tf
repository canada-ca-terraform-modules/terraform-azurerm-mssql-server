...
module "sqlserver" {
  source = "git::https://github.com/canada-ca-terraform-modules/terraform-azurerm-mssql-server.git?ref=v1.0.2"
  ...
  */
  ...
  private_endpoint_subnet_ids                   = [data.azurerm_subnet.devcc-back.id]
